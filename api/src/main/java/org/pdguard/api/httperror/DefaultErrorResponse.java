...
/**
 * This class defines the default error response from escrow agent.
 *
 * This response is not associated with '400' or '401' status codes.
 *
 * @author Thodoris Sotiropoulos
 */
public final class DefaultErrorResponse implements EscrowAgentErrorResponse {
    /**
     ...
     */
    @Override
    public EscrowAgentErrorResponseException
    getErrorResponseException(final String errorResponse) {
        return new EscrowAgentErrorResponseException(errorResponse);
    }
}
